...
{
    public partial class ProcurarCliente_Venda : Form
    {
        // Define o delegate para o evento do cliente selecionado
        public delegate void ClienteSelecionadoHandler(string nomeCliente);

        // Evento acionado quando um cliente é selecionado
        public event ClienteSelecionadoHandler ClienteSelecionado;
        private string connectionString;
        public ProcurarCliente_Venda()
        {
            InitializeComponent();
        ...
        private void dataGridView1_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (e.RowIndex >= 0)
            {
                ...
                string nomeCliente = dataGridView1.Rows[e.RowIndex].Cells["Nome do Cliente"].Value.ToString();

                // Aciona o evento de cliente selecionado e transmite o nome do cliente
                ClienteSelecionado?.Invoke(nomeCliente);
            }
            this.Close();
        }
    }
