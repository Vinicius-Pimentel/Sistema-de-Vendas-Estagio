...
{
    public partial class CadastroFornecedor_Menu : Form
    {
        private string connectionString;
        public CadastroFornecedor_Menu()
        {
            InitializeComponent();
        ...
        {
            CadastroFornecedor_Cadastro frm = new CadastroFornecedor_Cadastro();
            frm.Show();
        }
        ...
        private void AtualizarValorNoBancoDeDados(object primaryKeyValue, int columnIndex, object editedValue)
        {
            ...
            using (MySqlConnection conexao = new MySqlConnection(connectionString))
            {
                try
                {
                    ...
                    string updateSql = "UPDATE fornecedores SET ";
        ...
        {
            CadastroFornecedor_Excluir frm = new CadastroFornecedor_Excluir();
            frm.Show();
        }
    }
}
